...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        try {
            String ip = env.getProperty("database.ip", "127.0.0.1");
            String port = env.getProperty("database.port", "3306");
            String name = env.getProperty("database.name", "noteblogv4");
            String user = env.getProperty("database.username", "root");
            String pass = env.getProperty("database.password", "123456");
